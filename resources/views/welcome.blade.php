            ...
            <div class="col-md-9 mx-auto">
                <div class="row">
                    <div class="col-md-6 alert alert-info" role="alert">
                        ...
                        <p>همانطور که قول داده بودیم میخواهیم تا 4 مهر 1398 بین مهم ترین کتابهای هر درس نظر سنجی برگزار کنیم تا از سایت چی بخونم، براشون 25% تخفیف بگیریم.</p>
                    ...
                    <div class="col-md-6  alert alert-warning" role="alert">
                        ...
                        <p>جوایزی که سایت چی بخونم ویژه کسانی که در نظرسنجی شرکت می کنند و از سایتشون خرید می کنند، در نظر گرفته:</p>
                        <p>
                            <strong>
                                1-
                        ...
                        <p>
                            ...
                            کد تخفیف 5% همایش های آلاء
                        </p>
                        <p>
                            <strong>
                                4-
                                پایان پویش کتاب من (ویژه کسانی که از چی بخونم کتاب تهیه می کنند)</strong>
                            کد تخفیف 25% همایش های آلاء
                        </p>
                    </div>
                </div>
